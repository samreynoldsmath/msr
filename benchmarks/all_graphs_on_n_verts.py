...
def main(n: int):
	...
	if not_tight == 0:
		...
		print(f'{not_tight} out of {num_graphs} graphs' +
...
def num_graphs_on_n_verts(n: int):
	...
	a = [1, 1, 1, 2, 6, 21, 112, 853, 11117, 261080, 11716571, 1006700565,
  		164059830476, 50335907869219, 29003487462848061, 31397381142761241960,
		63969560113225176176277, 245871831682084026519528568,
		1787331725248899088890200576580, 24636021429399867655322650759681644]
	return a[n]
